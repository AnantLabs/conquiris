...
/**
 * Default class for boolean schema item implementations.
...
final class DefaultBooleanSchemaItem extends AbstractIndexableSchemaItem implements BooleanSchemaItem {
	 ...
	 */
	DefaultBooleanSchemaItem(String name, int minOccurs, int maxOccurs, boolean stored, boolean indexed) {
		super(name, minOccurs, maxOccurs, stored, indexed);
		this.hash = Objects.hashCode(name, minOccurs, maxOccurs, stored, indexed);
	}
	...
	public final boolean equals(Object obj) {
		if (obj instanceof BooleanSchemaItem) {
			BooleanSchemaItem other = (BooleanSchemaItem) obj;
			return hash == other.hashCode() && getName().equals(other.getName()) && getMinOccurs() == other.getMinOccurs()
					&& getMaxOccurs() == other.getMaxOccurs() && isStored() == other.isStored()
